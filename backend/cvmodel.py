...
def generate_cover_letter(job_description, skills):
    """
    ...
    """
    try:
        # Prepare the prompt with the job description and skills
        prompt = f"""
        ...
        - Begin with a strong opening paragraph stating enthusiasm for the role.
...
if __name__ == "__main__":
    # Job description and relevant skills
    job_description = (
    ...
    cover_letter = generate_cover_letter(job_description, skills)
